...
Welcome to the eCommerce App! This project is a web application built with Vue.js and uses Mock Service Worker (MSW) for API mocking.
...
```sh
git clone https://github.com/themeselection/e-commerce-app.git
```

### Head to typescript-version
